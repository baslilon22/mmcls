train_data_root = '/data4/lj/Dataset/TongYi/Cls_Standard_11_9'
test_data_root = '/data4/lj/Dataset/TongYi/cls_test'
work_dir = 'work_dirs/swin_tiny/Tongyi/11_9'
num_classes = 149
batch_size = 180
max_epochs = 200
interval_save = 50
...
data = dict(
    ...
    train=dict(
        type='CustomDataset',
        data_prefix='/data4/lj/Dataset/TongYi/Cls_Standard_11_9',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='Rotate', angle=8.0, interpolation='bicubic'),
            dict(
